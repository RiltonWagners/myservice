            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(Request::is('*business/edit*'))
                        <form name="businessForm" id="businessForm" class="row g-3" method="POST" action="/business/update" data-services-url="{{ route('loadservices')}}" data-cities-url="{{ route('loadcities')}}" data-district-url="{{ route('loaddistrict')}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Informe o nome do negócio" value="{{$business->name}}">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="description" class="form-label">Descrição*</label>
                                        <textarea class="form-control" id="description" name="description" rows="7" placeholder="Informe a descrição do negócio">{{$business->description}}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="id_category" name="id_category" class="form-select">
                                            ...
                                            <option value="{{$category->id}}" {{$category->id == $business->service->id_category ? 'selected' : ''}}>{{$category->name}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="id_service" name="id_service" class="form-select">
                                            ...
                                            <option value="{{$service->id}}" {{$service->id == $business->id_service ? 'selected' : ''}}>{{$service->name}}</option>
                                            @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md-3" id="div_zipcode">
                                        ...
                                        <input type="text" class="form-control" id="zipcode" name="zipcode" onKeyup="loadzipcode(this.value)" placeholder="Informe o CEP" value="{{$business->zipcode}}">
                                    </div>
                    ...
                    @else
                        <form name="businessForm" id="businessForm" class="row g-3" method="POST" action="/business" data-services-url="{{ route('loadservices')}}" data-cities-url="{{ route('loadcities')}}" data-district-url="{{ route('loaddistrict')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label for="name" class="form-label">Nome*</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Informe o nome do negócio">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="description" class="form-label">Descrição*</label>
                                        <textarea class="form-control" id="description" name="description" rows="7" placeholder="Informe a descrição do negócio"></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="file" class="form-control" id="images" name="images[]" multiple aria-describedby="inputGroupFileAddon04" accept="image/*">
                                    </div>
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary" type="submit" id="btn_create">
                                    <div id="id_btn_create_text">Criar meu negócio</div>
                                </button>
                            </div>
                        </form>
                    @endif
