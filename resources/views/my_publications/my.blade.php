                        ...
                        <div class="media" style="height: auto; display: inline;">
                            <div class="media-body" style="padding: 5px; display: flex; margin: 10px;">
                                ...
                                <div>
                                    ...
                                    @if($loop->first)
                                    <a href="{{ route('my_publication.show', $publication->id)}}" class="align-self-center mr-1" style="text-decoration: none;">
                                ...
                                <div style="margin-left: inherit;">
                                    <div>
                                        <a href="{{ route('my_publication.show', $publication->id)}}" class="stretched-link" style="text-decoration: none; color: #4a4a4a; padding-right: 10px;">
                                ...
                                <div class="media-body-description">
                                    ...
                                    <div class="media-body-city">
                                        <span class="mb-2 text" style="font-size: 14px;">
                                            ...
                                            <a href="{{ route('my_publication.show', $publication->id)}}" class="stretched-link" style="text-decoration: none; color: #4a4a4a; padding-right: 10px;">{{$publication->city->name}}/{{$publication->city->state->uf}}</a></span>
                                    </div>
                                </div>
