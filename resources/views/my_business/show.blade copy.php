                    ...
                    <div class="card-deck">
                        <div class="card text-center col-md-12" style="box-shadow: 0 0 5px black; flex-flow: wrap;">
                            ...
                            <div class="card-body list-group col-md-6">
                                <a class='btn btn-outline-primary' href="{{ route('my_business.show', $my_business->id)  }}"  style="padding: 9px;font-weight: 500;font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Ubuntu,sans-serif;font-size:16px;">Ver</a>
                            </div>
                            <div class="card-body list-group col-md-6">
